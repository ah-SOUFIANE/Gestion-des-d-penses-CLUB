...
@WebServlet("/ajouterDepenseUser")
public class AjouterDepenseUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Charger les catégories et clubs pour l'utilisateur
        ...
        request.getRequestDispatcher("ajouterDepenseUser.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ok) {
                ...
                response.sendRedirect("ajouterDepenseUser.jsp?error=1");
            }
